...
|---|---|---|---|---|
| `src/hawk_hooks/v2_cli.py` module name | completed | `src/hawk_hooks/cli.py` | 2026-02-23 | v2 CLI is now the primary CLI module; entrypoints point to `hawk_hooks.cli:main`. |
